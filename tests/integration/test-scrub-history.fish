...
cp (test_fixture_path history-secrets.txt) $tmp_home/.local/share/fish/fish_history

set -l out_file (mktemp)
env HOME=$tmp_home fish $AUR_SCRIPTS_DIR/scrub-history.fish --dry-run >$out_file 2>&1
