# aur-response-toolkit devcontainer
...
Includes Rust, Cargo, rustfmt, Clippy, a C compiler, compression tools and
Python validation tools. Tests use fixtures. Arch package-database integration
and remediation require a separate disposable Arch environment.
